...
export const elements = {
  ...
  "lawful-basis": [
    { id: "purposes", label: "the specific purposes you process for", basis: "law", probe: /purpose|in order to|we use (it|this|your|the)/i },
    { id: "permission", label: "what permits each purpose — the basis, consent, or the exception relied on", basis: "law", probe: /legal basis|lawful basis|legitimate interest|performance of (a |the )?contract|legal obligation|with your consent|you consent|necessary (for|to)/i },
  ],
