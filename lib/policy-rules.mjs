 ...
 */
export function analyzePolicy(obligations, policyText) {
  ...
  return obligations.map((o) => {
    ...
    if (sc.scope === "not-assessable") {
      return { ...o, verdict: "NOT ASSESSABLE", scopeReason: sc.reason, evidence: [] };
    }
    ...
    return { ...o, verdict, scopeReason: sc.reason, evidence, severity: SEVERITY[o.strictness] ?? null };
  });
}
